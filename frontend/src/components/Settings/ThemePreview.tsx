...
const SAMPLE_MESSAGES: ChatMessageType[] = [
    ...
    },
    {
        ...
        tags: {},
        avatar: '',
        fragments: [{ type: 'text', text: 'is excited for the stream', url: '' }],
        superChat: null,
        membershipEvent: false,
    },
    {
    ...
    },
    {
        ...
        avatar: '',
        fragments: [
            { type: 'text', text: 'Love the new overlay ', url: '' },
            {
                type: 'emote',
                text: 'PogChamp',
    ...
    },
    {
        ...
        tags: {},
        avatar: '',
        fragments: [{ type: 'text', text: 'Love being part of this community!', url: '' }],
        superChat: null,
        membershipEvent: false,
        eventType: 'resub',
    ...
    },
    {
        ...
        tags: {},
        avatar: '',
        fragments: [{ type: 'text', text: 'Remember to follow the chat rules everyone!', url: '' }],
        superChat: null,
        membershipEvent: false,
    },
    {
    ...
    },
    {
        ...
        tags: {},
        avatar: '',
        fragments: [{ type: 'text', text: 'finally decided to say something in chat', url: '' }],
        superChat: null,
        membershipEvent: false,
    },
    {
    ...
    },
    {
        ...
        tags: {},
        avatar: '',
        fragments: [{ type: 'text', text: 'Stream schedule has been updated for next week!', url: '' }],
        superChat: null,
        membershipEvent: false,
    ...
    },
    {
        ...
        avatar: '',
        fragments: [
            { type: 'text', text: 'LOL ', url: '' },
            { type: 'emote', text: 'HeyGuys', url: 'https://static-cdn.jtvnw.net/emoticons/v2/30259/default/dark/1.0' },
            { type: 'text', text: ' that was hilarious', url: '' },
        ],
        superChat: null,
        membershipEvent: false,
    },
